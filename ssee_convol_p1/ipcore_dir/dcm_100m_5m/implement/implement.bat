...
xst -ifn xst.scr
move dcm_100m_5m_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm_100m_5m_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_100m_5m_exdes.ucf dcm_100m_5m_exdes

echo 'Running map'
map -timing -pr b dcm_100m_5m_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm_100m_5m_exdes -w routed.ncd routed.vhd
cd ..
